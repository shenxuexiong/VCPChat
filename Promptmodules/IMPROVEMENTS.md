...
**实现位置：**
- [`modular-prompt-module.js:759-780`](Promptmodules/modular-prompt-module.js:759) - 拖拽事件处理
- [`modular-prompt-module.js:1115-1174`](Promptmodules/modular-prompt-module.js:1115) - 拖拽逻辑
- [`prompt-modules.css:595-632`](Promptmodules/prompt-modules.css:595) - 指示器样式
