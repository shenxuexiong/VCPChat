...
请下载壁纸包放入assets文件夹内，以避免元素窗口异常：https://github.com/lioensky/VCPChat/releases
...
*   **语音朗读 (TTS)**:
    ...
    *   **下载链接**：[下载引擎](https://modelscope.cn/models/aihobbyist/GPT-SoVITS-Inference/files)，20-40系卡使用124，50系卡使用128。
